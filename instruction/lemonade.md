...
- Download firmware and update to 14.0.0.730(EX01) using Firmware-Flasher [**HERE**](https://sourceforge.net/projects/projectmatrixx/files/Android-15/lemonade/Utility/)
...
- Download from [**HERE**](https://sourceforge.net/projects/projectmatrixx/files/Android-15/lemonade/Utility/) and extract recovery package then execute __recovery.bat__ or __recovery.sh__ as per your computer OS 
